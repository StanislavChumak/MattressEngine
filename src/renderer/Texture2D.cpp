...
namespace RenderEngine
{
    ...
    void Texture2D::add_sub_texture(const sys::Str &subTextureName, const glm::vec2 &leftBottomVertex, const glm::vec2 &rightTopVertex)
    {
        _subTexturesMap.emplace(subTextureName, SubTexture2D(leftBottomVertex, rightTopVertex));
    }

    const Texture2D::SubTexture2D &Texture2D::get_sub_texture(const sys::Str &subTextureName) const
    {
